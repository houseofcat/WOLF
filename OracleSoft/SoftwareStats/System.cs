    ...
    { 
        ...
        public double nextSYS_FLOATEMUSEC()
        {
            ...
            if (Loaded)
            {
                try
                {
                    temp = SYS_FLOATEMUSEC.NextValue();
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.ToString());
        ...
        public double nextSYS_FCONBYTESEC()
        {
            ...
            if (Loaded)
            {
                try
                {
                    temp = SYS_FCONBYTESEC.NextValue();
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.ToString());
