    ...
    class Core: IDisposable
    {
        ...
        public double nextCore_PINTERTIME()
        {
            ...
            if (Loaded)
            {
                try
                {
                    temp = Core_PINTERTIME.NextValue();
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.ToString());
        ...
        public double nextCore_PARKSTATUS()
        {
            ...
            if (Loaded)
            {
                try
                {
                    temp = Core_PARKSTATUS.NextValue();
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.ToString());
        ...
        public double nextCore_PROCSTATEFLAGS()
        {
            ...
            if (Loaded)
            {
                try
                {
                    temp = Core_PROCSTATEFLAGS.NextValue();
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.ToString());
        ...
        public double nextCore_DPCQUEUEDSEC()
        {
            ...
            if (Loaded)
            {
                try
                {
                    temp = Core_DPCQUEUEDSEC.NextValue();
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.ToString());
