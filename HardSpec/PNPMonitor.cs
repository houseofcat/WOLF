...
namespace Wolf.HardSpec
{
    class PNPMonitor
    {
        ...
        public PNPMonitor(ManagementObject monInfo)
        {
        ...
        private void setMonitorInfo(ManagementObject monInfo)
        {
            ...
            if (monInfo["Service"] != null)
            {
                string temp = monInfo["Service"].ToString();
                Type = temp;
                MONInfo.Add("Service: " + temp);
            }
            else
            {
                MONInfo.Add("Manufacturer: No Data (xNull).");
            }

            if (monInfo["Manufacturer"] != null)
            {
                string temp = monInfo["Manufacturer"].ToString();
                Manufacturer = temp;
                MONInfo.Add("Manufacturer: " + temp);
            }
            else
            {
                MONInfo.Add("Manufacturer: No Data (xNull).");
            ...
            if (monInfo["ClassGuid"] != null)
            {
                MONInfo.Add("ClassGuid: " + monInfo["ClassGuid"].ToString());
            }
            else
            {
                MONInfo.Add("ClassGuid: No Data (xNull).");
            }
